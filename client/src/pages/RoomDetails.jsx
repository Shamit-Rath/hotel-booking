  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl max-auto mt-16 max-w-6xl'>
            ...
            <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
                Book Now    
            </button>
        </form>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guests will be placed on the ground floor based on availability. The apartment offers a cozy two-bedroom setup with an authentic city vibe. The quoted price covers two guests; to receive an accurate rate for larger groups, please specify the number of guests when booking. Ground floor placement is subject to availability. Enjoy a comfortable two-bedroom apartment that captures the essence of city living.</p>
        </div>
